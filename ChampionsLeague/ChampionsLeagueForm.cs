    ...
    public partial class ChampionsLeagueForm : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txt1.SetBounds(100, 36, 200, 20);
                txt1.Text = records.players[listViewPlayers.FocusedItem.Index].Name;

                cb.SetBounds(100, 72, 200, 20);
                cb.SelectedItem = (FootballClub)records.players[listViewPlayers.FocusedItem.Index].Club;

                txt2.SetBounds(100, 108, 200, 20);
                txt2.Text = records.players[listViewPlayers.FocusedItem.Index].GoalCount+"";
                ...
                if (form1.DialogResult == DialogResult.OK)
                {
                    ...
                    records.players[listViewPlayers.FocusedItem.Index].Name = txt1.Text;
                    records.players[listViewPlayers.FocusedItem.Index].Club = (FootballClub)cb.SelectedItem;
                    records.players[listViewPlayers.FocusedItem.Index].GoalCount = Int32.Parse(txt2.Text);
